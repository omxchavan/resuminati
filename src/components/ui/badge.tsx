...
const badgeVariants = cva(
  "group/badge inline-flex h-6 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2.5 py-0.5 text-xs font-semibold whitespace-nowrap transition-all focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        default: "neo-sm text-french-blue dark:text-cool-sky [a]:hover:neo-interactive",
        secondary:
          "neo-pressed text-secondary-foreground",
        destructive:
          "neo-sm text-destructive [a]:hover:neo-interactive",
        outline:
          "neo-pressed text-foreground",
        ghost:
          "hover:neo-pressed hover:text-muted-foreground dark:hover:bg-muted/50",
